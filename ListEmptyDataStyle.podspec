...
Pod::Spec.new do |spec|
  ...
  ListEmptyDataStyle 设置UITableView、UICollectionView无数据时候的占位视图样式.
  ...
  spec.source       = { :git => "https://github.com/dxsGitHub/ListEmptyDataStyle.git", :tag => "#{spec.version}" }
  ...
  spec.vendored_frameworks = "ListEmptyDataStyle.framework" 
